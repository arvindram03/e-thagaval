# Django settings for ethagaval project.
...
ROOT_URLCONF = 'ethagavalprj.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'ethagavalprj.wsgi.application'
...
EMAIL_SUBJECT_PREFIX = '[ethagavalprj] '
...
WAGTAIL_SITE_NAME = 'ethagavalprj'

# Override the search results template for wagtailsearch
WAGTAILSEARCH_RESULTS_TEMPLATE = 'ethagaval/search_results.html'
